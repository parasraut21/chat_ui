...
export default function Chat() {
  ...
  useEffect(() => {
    if (currentUser) {
      socket.current = io("https://chat-server2-ab56.onrender.com");
  ...
  useEffect(async () => {
    if (currentUser) {
      if (currentUser.isAvatarImageSet) {
        const data = await axios.get(`https://chat-server2-ab56.onrender.com/api/auth/allusers/${currentUser._id}`);
